  ...
  return (
    <>
      ...
      <div className="shop">
        ...
        />
        <h3 className="same-changes guide-text">
          please choose your favorite products below
        </h3>
        {status[0] ? (
          <button className="products-btns" onClick={() => handleClick(1)}>
            duffel bag
          </button>
        ) : null}
        {status[1] ? (
          <button className="products-btns" onClick={() => handleClick(2)}>
            work bag
          </button>
        ) : null}
        {status[2] ? (
          <button className="products-btns" onClick={() => handleClick(3)}>
            baseball bag
          </button>
        ) : null}
        {status[3] ? (
          <button className="products-btns" onClick={() => handleClick(4)}>
            travel bag
          </button>
        ) : null}
        {status[4] ? (
          <button className="products-btns" onClick={() => handleClick(5)}>
            women's bag
          </button>
        ) : null}
        <br></br>
        ...
        {productName.map(({ name, count }) => {
          return (
            <>
              <h1 style={{ width: "300px" }} className="same-changes">
                {`${name} ${count}`}{" "}
              </h1>
            </>
          );
